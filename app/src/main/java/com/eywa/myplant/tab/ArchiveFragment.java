...
public class ArchiveFragment extends Fragment implements OnBackPressedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                if (archiveCategoryRecyclerViewAdapter != null) {
    ...
    public ArchiveCategoryRecyclerViewAdapter createArchiveInstance() {
        if (!isDatabaseInitialized) {
            Log.d("createArchiveInstance", "데이터베이스 삽입");
            ...
            for (ArchiveHolderContent item : archiveHolderContentList1) { dbHelper.addPlantArchive(item);}
            ...
            for (ArchiveHolderContent item : archiveHolderContentList7) { dbHelper.addPlantArchive(item);}
            ...
            for (ArchiveHolderContent item : archiveHolderContentList8) { dbHelper.addPlantArchive(item);}
            ...
            for (ArchiveHolderContent item : archiveHolderContentList9) { dbHelper.addPlantArchive(item);}
            ...
            for (ArchiveHolderContent item : archiveHolderContentList12) { dbHelper.addPlantArchive(item);}
            ...
            for (ArchiveHolderContent item : archiveHolderContentList14) { dbHelper.addPlantArchive(item);}
            ...
            return new ArchiveCategoryRecyclerViewAdapter(new ArrayList<>());
    }
}